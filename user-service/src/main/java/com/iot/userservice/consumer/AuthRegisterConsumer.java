...
//
//                // 🌟 THÊM: Bắn tin nhắn CONFIRM thành công (SUCCESS) về cho auth-service
...
//
//                // 🌟 ĐÂY LÀ DÒNG LOG BẠN ĐANG TÌM KIẾM:
...
//        }
    ...
    public void handleDlt(String message) {
        ...
        try {
            ...
            // Bắn tin nhắn Rollback
            kafkaTemplate.send(CONFIRM_TOPIC, userCreatedEvent.getUserId(), rejectEvent);

            // Log thông báo bắn tin nhắn thất bại
